...
def _event_handler(event_type, slack_event):
    # When the user reacts to a message in one channel, if it is reaction added event...
    if event_type == "reaction_added":
        # slack_event["event"]["item"]["channel"]
        slack_reaction = slack_event["event"]["reaction"]
        channel_id = slack_event["event"]["item"]["channel"]
        user_id = slack_event["event"]["user"]
        # Post the message to the same channel
        pyBot.reaction_msg(channel_id, slack_reaction, user_id)
